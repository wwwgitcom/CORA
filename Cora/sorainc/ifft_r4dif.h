...
IFFTSSEEx<8> (vcs* pInput)
{
    ...
    xmm0 = saturated_add(xmm0, xmm1);                  // xmm0 = a + b, for 4-point IFFT
    ...
    xmm0 = xor(xmm0, xmm3);                             // xmm0 = -Q3 -I3 Q2 I2 -Q1 -I1 Q0 I0
    xmm0 = saturated_add(xmm0, xmm2);                  // 4-IFFT Over
