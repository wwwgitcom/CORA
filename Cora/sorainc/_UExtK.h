...
void SoraKUExtKeDtor(PUEXT_KE  UExtKeObj, PSORA_RADIO Radio);
...
void SoraKUExtKMapModBuffer(PUEXT_KE ExtObj, PSORA_RADIO Radio, PMAP_MOD_BUF_OUT Out);
HRESULT SoraKUExtKUnmapModBuffer(PUEXT_KE ExtObj, PSORA_RADIO Radio, PVOID UserBuffer);
...
HRESULT SoraKTxDoneByID(PTX_SIGNAL_QUEUE TxQueue, PSORA_RADIO Radio, ULONG sid);
