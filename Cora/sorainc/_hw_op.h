...
s_uint32 SORAAPI SoraHwFirmwareVersion(PSORA_RADIO pRadio);
...
VOID SORAAPI SoraHwPrintDbgRegs(PSORA_RADIO pRadio);
...
HRESULT 
SORAAPI 
SORA_HW_TX_TRANSFER ( IN PSORA_RADIO  pRadio, 
                      IN PPACKET_BASE pPacket );

HRESULT
SORAAPI
SORA_HW_FAST_TX_TRANSFER(PSORA_RADIO pRadio, PTX_DESC pTxDesc);
