...
struct stream_paser_bpsk_2ss
{
  ...
  __forceinline void operator()(unsigned __int8 pInput[13], unsigned __int8 pOutput1[], unsigned __int8 pOutput2[])
  {
    int i = 0, j = 0;
...
struct stream_paser_qpsk_2ss
{
  ...
  __forceinline void operator()(unsigned __int8 pInput[26], unsigned __int8 pOutput1[], unsigned __int8 pOutput2[])
  {
    int i = 0, j = 0;
...
struct stream_paser_16qam_2ss
{
  ...
  __forceinline void operator()(unsigned __int8 pInput[52], unsigned __int8 pOutput1[], unsigned __int8 pOutput2[])
  {
    int i = 0, j = 0;
...
struct stream_paser_64qam_2ss
{
  ...
  __forceinline void operator()(unsigned __int8 pInput[78], unsigned __int8 pOutput1[], unsigned __int8 pOutput2[])
  {
