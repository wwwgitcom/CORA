...
void dot11n_2x2_rx_profile(int argc, _TCHAR* argv[])
{
  ...
  // TO emulate KUN's code
  autoref depuct_1 = create_block<b_passthru_1v1>();
  autoref depuct_2 = create_block<b_passthru_1v1>();
  autoref vit_src  = create_block<b_passthru_1v1>();
  //
  ...
  {
    bool bFinish = false;
    START(WHILE(IsTrue(!bFinish)), vit_src, ht_data_vit_12, descramble, crc32_checker, STOP([&]{bFinish = true;}));
  };

  auto rx_vit23_pipeline = [&]
  {
    bool bFinish = false;
    START(WHILE(IsTrue(!bFinish)), vit_src, ht_data_vit_23, descramble, crc32_checker, STOP([&]{bFinish = true;}));
  };

  auto rx_vit34_pipeline = [&]
  {
    bool bFinish = false;
    START(WHILE(IsTrue(!bFinish)), vit_src, ht_data_vit_34, descramble, crc32_checker, STOP([&]{bFinish = true;}));
  };
  //////////////////////////////////////////////////////////////////////////
  ...
  auto rx_bpsk_pipeline_1 = [&]() -> bool
  {
    START(src, wait_ofdm, STOP([&]
    {
      ...
      ONCE(ht_demap_bpsk1, ht_deinterleave_1bpsc_iss1, depuct_1,
        ht_demap_bpsk2, ht_deinterleave_1bpsc_iss2, depuct_2, ht_stream_joiner_1);
    }));
  ...
  auto rx_qpsk_pipeline_1 = [&]() -> bool
  {
    START(src, wait_ofdm, STOP([&]
    {
      ...
      ONCE(ht_demap_qpsk1, ht_deinterleave_2bpsc_iss1, depuct_1,
        ht_demap_qpsk2, ht_deinterleave_2bpsc_iss2, depuct_2, ht_stream_joiner_1);
    }));
  ...
  auto rx_16qam_pipeline_1 = [&]() -> bool
  {
    START(src, wait_ofdm, STOP([&]
    {
      ...
      ONCE(ht_demap_16qam1, ht_deinterleave_4bpsc_iss1, depuct_1,
        ht_demap_16qam2, ht_deinterleave_4bpsc_iss2, depuct_2, ht_stream_joiner_2);
    }));
  ...
  auto rx_64qam_pipeline_1 = [&]() -> bool
  {
    START(src, wait_ofdm, STOP([&]
    {
      ...
      ONCE(ht_demap_64qam1, ht_deinterleave_6bpsc_iss1, depuct_1,
        ht_demap_64qam2, ht_deinterleave_6bpsc_iss2, depuct_2, ht_stream_joiner_3);
    }));
